...
import 'package:motor_frontend/core/services/motor_data_worker.dart';
...
final _bridge = MotorDataWorkerBridge();
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider<MotorDataWorkerBridge>.value(value: _bridge),
